...
var createNewTaskElement=function(taskString){
  ...
  deleteButtonImg.className="todo-item__icon todo-item__icon--delete";
...
var editTask=function(){
  ...
  var containsClass=listItem.classList.contains("todo-item--edit-mode");
  ...
  listItem.classList.toggle("todo-item--edit-mode");
};
...
var bindTaskEvents=function(taskListItem,checkBoxEventHandler){
  ...
  var editButton=taskListItem.querySelector("button.todo-item__button--edit");
  var deleteButton=taskListItem.querySelector("button.todo-item__button--delete");
